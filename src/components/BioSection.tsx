...
const BioSection = () => {
  return (
    <section id="bio" className="w-full bg-background py-24 px-12 md:px-20 lg:px-32">
      <p className="font-heading text-xl md:text-2xl text-foreground text-justify leading-relaxed max-w-5xl mx-auto">
        <span className="font-bold italic">Dr. Gastón Enrique Espinosa </span>
      ...
      <p className="font-heading italic text-xl md:text-2xl text-foreground mt-8 max-w-5xl mx-auto">
        Learn more about his research, teaching, and impact using the header links.
      </p>
    </section>
  );
};
